...
namespace fromtheoutfit\ipstack;

use fromtheoutfit\ipstack\services\IpstackService as IpstackServiceService;
use fromtheoutfit\ipstack\variables\IpstackVariable;
 ...
 * @since     1.0.0
 *
 * @property  IpstackServiceService $ipstackService
 */
